...
function index()
{
	...
	ob_start();
	$success = @require dirname(__FILE__).'/ioncube-encoded-file.php';
	$php_info = ob_get_contents();
	ob_end_clean();

	$body = "";

	$body.="Checking to see if your server supports ioncube loading...$nl$nl";
	...
	if ($success)
	{
	   ...
	   $body .= "<div align='center'><a href=\"index.php?step=1\" class='continue'>Click Here To Continue</a></div>";
	...
	{
		$body.=	"<font color='red'>The required ioncube loaders could not be verified on this server.</font><br />\n";
		
		$body.= "<p>We suggest you download new loaders from ioncube, or ask your web host to install them for you.</p>";
		
		$body.= "<p>Ioncube Loaders can be downloaded from <a href='http://www.ioncube.com/loaders.php' target='_blank'>http://www.ioncube.com/loaders.php</a></p>";
		
		$body.= "<p><strong>You can still continue with the install now</strong>, then fix the ioncube loading issue later. A lot of times, you can just edit a php.ini or .htaccess file to get it running.</p>";
		
		$body .= "<p>If you need help installing, just let us know and we can install the software for you for a small fee</p>";
		
		$body .= "<div align='center' style='margin-bottom:2em'><a href=\"index.php?step=1\" class='continue'>Click Here To Continue</a></div>";
...
else
{
	...
	$css = getCSS();
	$out =	"<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><html xmlns=\"http://www.w3.org/1999/xhtml\">\n"
	.		"<head>\n"
	.		"<style>\n"
	.		"@charset \"utf-8\";
...
"
	...
	$body = "";
	$body.="<div class=\"jroxContainer\">\n";
	$body.="<h1>Application Installer - Check Ioncube Loaders...</h1><div class=\"jroxContent\">\n";
