                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="<?=site_url()?>switch_language/<?=$v['name']?>"><i class="flag-<?=$v['image']?>"></i> <?=$v['name']?></a></li>
                                    <?php endforeach;?>
                                </ul>
                            </li>
                            <?php endif; ?>
                            ...
                            <li><a href="<?=site_url('members')?>"><?=$this->lang->line('dashboard')?></a></li> 
                            <li class="dropdown">
                            	<a href="#" class="dropdown-toggle" data-toggle="dropdown"><?=$this->lang->line('profile')?> <span class="caret"></span></a>
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="<?=site_url('members')?>/account/"><?=$this->lang->line('account_profile')?></a></li>
                                    <li><a href="<?=site_url('members')?>/account/reset_password"><?=$this->lang->line('reset_password')?></a></li>
                                </ul>
                            </li>
                            <?php if ($this->session->userdata('userid')): ?>
                            <li><a href="<?=site_url('members')?>/logout/<?=$prg_signup_link?>"><?=$this->lang->line('logout')?></a></li> 
                            <?php endif; ?>
                            <?php else: ?>
