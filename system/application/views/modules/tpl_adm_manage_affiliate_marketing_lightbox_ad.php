...
<div class="row">
    ...
    <div class="col-md-8 text-right">
		...
		<?=_previous_next('previous', 'affiliate_lightbox_ads', $this->validation->id);?>
        <button class="btn btn-primary" data-toggle="modal" data-target="#preview"><i class="fa fa-search-plus"></i> <span class="hidden-xs"><?=$this->lang->line('preview')?></span></button>
         <a data-href="<?=modules_url()?>module_affiliate_marketing_lightbox_ads/delete/<?=$this->validation->id?>" data-toggle="modal" data-target="#confirm-delete" href="#" class="md-trigger btn btn-danger"><i class="fa fa-trash-o"></i> <span class="hidden-xs"><?=$this->lang->line('delete')?></span></a>
        <?php endif; ?>
        <a href="<?=modules_url()?>module_affiliate_marketing_lightbox_ads/view" class="btn btn-primary"><i class="fa fa-search"></i> <span class="hidden-xs"><?=$this->lang->line('view_lightbox_ads')?></span></a>
        <?php if ($function == 'edit'):?>
        <?=_previous_next('next', 'affiliate_lightbox_ads', $this->validation->id);?>
        <?php endif; ?>
    </div>
</div>
<hr />
	...
	<div class="col-md-12">
		<div class="box-info">
        	...
        	<div class="form-group">
    		    <label for="lightbox_ad_name" class="col-sm-3 control-label"><?=$this->lang->line('lightbox_ad_name')?></label>
        		<div class="col-lg-5">
        			<input name="lightbox_ad_name" type="text" class="form-control required" placeholder="<?=$this->lang->line('name')?>" value="<?=$this->validation->lightbox_ad_name?>" />
        		</div>
        	</div>
            <hr />
            <div class="form-group">
            ...
            <div class="form-group">
        		...
        		<div class="col-sm-5 text-right">
        			  <?=_generate_dynamic_tags('lightboxads')?>           
        		</div>
        	</div>
            <hr />
            <div class="form-group">
            ...
            <hr />
            <div class="form-group">
    		    <label for="lightbox_ad_height" class="col-sm-3 control-label"><?=$this->lang->line('lightbox_ad_height')?></label>
        		<div class="col-lg-5">
        			<input name="lightbox_ad_height" type="text" class="form-control required" placeholder="150" value="<?=$this->validation->lightbox_ad_height?>" />
        		</div>
        	</div>
            <hr />
            <div class="form-group">
    		    <label for="lightbox_ad_width" class="col-sm-3 control-label"><?=$this->lang->line('lightbox_ad_width')?></label>
        		<div class="col-lg-5">
        			<input name="lightbox_ad_width" type="text" class="form-control required" placeholder="400" value="<?=$this->validation->lightbox_ad_width?>" />
        		</div>
        	</div>
            <hr />
            <div class="form-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <?=$this->validation->lightbox_ad_body?>
      </div>
