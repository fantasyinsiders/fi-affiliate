...
<div class="row">
    ...
    <div class="col-md-8 text-right">
		...
		<?=_previous_next('previous', 'affiliate_text_ads', $this->validation->id);?>
        <button class="btn btn-primary" data-toggle="modal" data-target="#preview"><i class="fa fa-search-plus"></i> <span class="hidden-xs"><?=$this->lang->line('preview')?></span></button>
         <a data-href="<?=modules_url()?>module_affiliate_marketing_text_ads/delete/<?=$this->validation->id?>" data-toggle="modal" data-target="#confirm-delete" href="#" class="md-trigger btn btn-danger"><i class="fa fa-trash-o"></i> <span class="hidden-xs"><?=$this->lang->line('delete')?></span></a>
        <?php endif; ?>
        <a href="<?=modules_url()?>module_affiliate_marketing_text_ads/view" class="btn btn-primary"><i class="fa fa-search"></i> <span class="hidden-xs"><?=$this->lang->line('view_text_ads')?></span></a>
        <?php if ($function == 'edit'):?>
        <?=_previous_next('next', 'affiliate_text_ads', $this->validation->id);?>
        <?php endif; ?>
    </div>
</div>
<hr />
	...
	<div class="col-md-12">
		<div class="box-info">
        	...
        	<div class="form-group">
    		    <label for="name" class="col-sm-3 control-label"><?=$this->lang->line('text_ad_name')?></label>
        		<div class="col-lg-5">
            ...
            <hr />
            <div class="form-group">
    		    <label for="text_ad_title" class="col-sm-3 control-label"><?=$this->lang->line('text_ad_title')?></label>
        		<div class="col-lg-5">
        			<input name="text_ad_title" type="text" class="form-control required" placeholder="<?=$this->lang->line('text_ad_title')?>" value="<?=$this->validation->text_ad_title?>" />
        		</div>
        	</div>
            <hr />
            <div class="form-group">
            ...
            <div class="form-group">
        		...
        		<div class="col-sm-5 text-right">
        			  <?=_generate_dynamic_tags('textads')?>           
        		</div>
        	</div>
            <hr />
            <div class="form-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?=$this->validation->text_ad_title?></h4>
      </div>
      <div class="modal-body">
       <?=_preview_module_code($this->validation->text_ad_body)?>
      </div>
