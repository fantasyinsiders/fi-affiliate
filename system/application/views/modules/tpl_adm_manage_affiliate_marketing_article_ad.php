...
<div class="row">
    ...
    <div class="col-md-8 text-right">
		...
		<?=_previous_next('previous', 'affiliate_article_ads', $this->validation->id);?>
        <button class="btn btn-primary" data-toggle="modal" data-target="#preview"><i class="fa fa-search-plus"></i> <span class="hidden-xs"><?=$this->lang->line('preview')?></span></button>
         <a data-href="<?=modules_url()?>module_affiliate_marketing_article_ads/delete/<?=$this->validation->id?>" data-toggle="modal" data-target="#confirm-delete" href="#" class="md-trigger btn btn-danger"><i class="fa fa-trash-o"></i> <span class="hidden-xs"><?=$this->lang->line('delete')?></span></a>
        <?php endif; ?>
        <a href="<?=modules_url()?>module_affiliate_marketing_article_ads/view" class="btn btn-primary"><i class="fa fa-search"></i> <span class="hidden-xs"><?=$this->lang->line('view_article_ads')?></span></a>
        <?php if ($function == 'edit'):?>
        <?=_previous_next('next', 'affiliate_article_ads', $this->validation->id);?>
        <?php endif; ?>
    </div>
</div>
<hr />
	...
	<div class="col-md-12">
		<div class="box-info">
        	...
        	<div class="form-group">
    		    <label for="name" class="col-sm-3 control-label"><?=$this->lang->line('article_ad_name')?></label>
        		<div class="col-lg-5">
            ...
            <hr />
            <div class="form-group">
    		    <label for="article_ad_title" class="col-sm-3 control-label"><?=$this->lang->line('article_ad_title')?></label>
        		<div class="col-lg-5">
        			<input name="article_ad_title" type="text" class="form-control required" placeholder="<?=$this->lang->line('article_ad_title')?>" value="<?=$this->validation->article_ad_title?>" />
        		</div>
        	</div>
            <hr />
            <div class="form-group">
            ...
            <div class="form-group">
        		...
        		<div class="col-sm-5 text-right">
        			  <?=_generate_dynamic_tags('articleads')?>           
        		</div>
        	</div>
            <hr />
            <div class="form-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?=$this->validation->article_ad_title?></h4>
      </div>
      <div class="modal-body">
       <?=_preview_module_code($this->validation->article_ad_body)?>
      </div>
