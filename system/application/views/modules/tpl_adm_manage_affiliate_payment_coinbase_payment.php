        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    	<?php if (!empty($name[2])): ?>
                    	<a href="<?=modules_url()?>module_affiliate_payment_coinbase_payment/direct_pay/<?=$this->convert->AsciiToHex(base64_encode($v['id'] . '-' . $name[2] . '-' . $v['total']))?>/2/<?=$offset?>/<?=$sort_order?>/<?=$sort_column?>/<?=$where_column?>/<?=$show_where_value?>"><img src="<?=base_url()?>images/misc/pay_bitcoin.png" /></a>
               			<?php endif; ?>
                    </td>
                </tr>
                <?php endforeach;?>
