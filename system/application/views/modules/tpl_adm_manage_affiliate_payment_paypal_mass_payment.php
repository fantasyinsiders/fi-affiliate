            ...
            <tbody>
                ...
                <tr>
                    <td class="text-center">
	                    <input name="user[<?=$v['id']?>]" type="checkbox" id="user[<?=$v['id']?>]" value="<?=format_amounts($v['total'], $num_options, true)?>" />
                    </td>
                    ...
                    <td class="text-center"><a href="https://www.paypal.com/cgi-bin/webscr?business=<?=$name[2]?>&cmd=_xclick&currency_code=USD&amount=<?=$v['total']?>&item_name=<?=$module_affiliate_payment_paypal_mass_payment_payment_details?>" target="_blank"><img src="<?=base_url('js')?>images/misc/pay_paypal.png" /></a></td>
                </tr>
                <?php endforeach;?>
            </tbody>
            <tfoot>
