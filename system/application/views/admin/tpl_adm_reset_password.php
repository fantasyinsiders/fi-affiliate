	    ...
	    <div class="full-content-center animated fadeInUp">
			<div class="login-wrap">
                <div class="box-info capitalize text-center">
                    ...
                    <?php endif; ?>
		            <?php endif; ?>
                    <form id="validateForm" name="form1" role="form" action="<?=base_url('js')?>admin_login/reset_password" method="post">
                    	<?php if ($this->session->flashdata('success')): ?>
                        <div class="alert alert-success"><small><?=$this->session->flashdata('success');?></small></div>
                        <?php elseif ($this->validation->email_error): ?>
                        <div class="alert alert-danger"><small><?=$this->validation->email_error; ?></small></div>
						<?php endif; ?>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                            <button type="submit" class="btn btn-info btn-block"><i class="fa fa-key"></i> <?=$this->lang->line('send_password_reset')?></button>
