	...
	<div class="col-md-12">
    	<div class="box-info">
            ...
            <div class="form-group">
                ...
                <div id="time_limit"><label class="col-lg-1 control-label"><?=$this->lang->line('for')?></label>
                <div class="col-sm-3">
                	<?php 
            ...
            <div class="form-group">
                ...
                <label class="col-lg-1 control-label"><?=$this->lang->line('amount')?></label>
                <div class="col-sm-3">
					<input name="bonus_amount" type="text" id="bonus_amount" value="<?=$this->validation->bonus_amount?>" class="form-control"/>
            		<?=form_dropdown('group_id', $groups, $this->validation->group_id, 'id="group_id" class="form-control" style="display:none"')?>
                </div>
            </div>
            <hr />
            <div class="form-group">
