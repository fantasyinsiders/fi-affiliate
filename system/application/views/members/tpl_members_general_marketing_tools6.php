	...
	<div class="panel panel-default animated fadeInDown">
        ...
        <div class="panel-body">
        	<div class="row text-capitalize">
                ...
                <div class="col-md-5"><h4><?=$this->lang->line('tool_name')?></h4></div>
            ...
            <div class="row">
                ...
                <div class="col-md-2 text-right">
                    <a data-toggle="collapse" data-target="#<?=$v['id']?>" class="btn btn-default"><i class="fa fa-plus"></i></a>
                	<a href="<?=site_url('members')?>/marketing/preview/<?=$module_file_name?>/<?=$v['id']?>" id="show-<?=$v['id']?>" class="btn btn-default"><i class="fa fa-search"></i></a>
                    <script>
					$("a#show-<?=$v['id']?>").colorbox({iframe:true, width:"650px", height: "400px"});
					</script>
                </div>
            </div>
            <div id="<?=$v['id']?>" class="row collapse fade">
            	<div class="col-lg-12">
                	...
                	<div class="well">
                        ...
                        <p><input class="form-control" type="text" value="<?=$v['s_title']?>" onclick="this.select()"/></p>
                        <textarea class="form-control" rows="5" onclick="this.select()"><?=$v['tool_code']?></textarea>
                    </div>
                </div>
            </div>
            <hr />
