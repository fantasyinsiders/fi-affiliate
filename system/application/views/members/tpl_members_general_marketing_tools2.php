            	...
            	<div class="col-lg-12">
                	...
                	<div class="well">
                        ...
                        <div class="panel panel-default">
                        	<div class="panel-body"><?=$v['p_tool_code']?></div>
                            <div class="panel-footer text-right"><a href="<?=site_url('members')?>/marketing/print_file/<?=$module_file_name?>/<?=$v['id']?>"  target="_blank" class="btn btn-default"><i class="fa fa-print"></i> <?=$this->lang->line('print')?></a></div>
                       	</div>
                    </div>
                </div>
            </div>
