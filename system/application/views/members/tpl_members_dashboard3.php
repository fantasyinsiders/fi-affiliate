	  ...
	  <div class="panel panel-default">
		  ...
		  <div id="icons" class="panel-body collapse in">
			  ...
			  <div class="row">
				  ...
				  <div class="dashboard-icons col-md-3 col-lg-2" onclick="window.location='<?=site_url('members')?>/account'">
				  ...
				  <div class="dashboard-icons col-md-3 col-lg-2" onclick="window.location='<?=site_url('members')?>/marketing'">
					  <div class="box-info text-center">
				  ...
				  <div class="dashboard-icons col-md-3 col-lg-2" onclick="window.location='<?=site_url('members')?>/traffic'">
					  <div class="box-info text-center">
				  ...
				  <div class="dashboard-icons col-md-3 col-lg-2" onclick="window.location='<?=site_url('members')?>/commissions'">
					  <div class="box-info text-center">
				  ...
				  <div class="dashboard-icons col-md-3 col-lg-2" onclick="window.location='<?=site_url('members')?>/content'">
					 <div class="box-info text-center">
				  ...
				  <div class="dashboard-icons col-md-3 col-lg-2" onclick="window.open('<?=site_url('members')?>/downline/view', 'popup', 'width=800,height=500, location=no, menubar=no, status=no,toolbar=no, scrollbars=yes, resizable=yes')">
					  <div class="box-info text-center">
				  ...
				  <div class="dashboard-icons col-md-3 col-lg-2" onclick="window.location='<?=site_url('members')?>/downloads'">
					  <div class="box-info text-center">
				  ...
				  <?php if ($sts_content_members_dashboard_enable_reports == 1): ?>
				   <div class="dashboard-icons col-md-3 col-lg-2" onclick="window.location='<?=site_url('members')?>/reports'">
					  <div class="box-info text-center">
				   ...
				   <div class="dashboard-icons col-md-3 col-lg-2" onclick="window.location='<?=site_url('members')?>/programs'">
					   <div class="box-info text-center">
				  ...
				  <?php endif; ?>
					...
					<div class="dashboard-icons col-md-3 col-lg-2" onclick="window.location='<?=site_url('members')?>/payments'">
						<div class="box-info text-center">
					...
					<div class="dashboard-icons col-md-3 col-lg-2" onclick="window.open('<?=$sts_content_members_video_tutorials?>', 'videos')">
						<div class="box-info text-center">
					...
					<div class="dashboard-icons col-md-3 col-lg-2" onclick="window.open('<?=$sts_content_members_help_link?>', 'help')">
						<div class="box-info text-center">
