...
if (!class_exists('TCPDF')) {
	 ...
	 */
	define('PDF_PRODUCER', 'TCPDF 5.5.015_PHP4 (http://www.tcpdf.org)');
	...
	*/
	class TCPDF {
		 ...
		 */
		function MultiCell($w, $h, $txt, $border=0, $align='J', $fill=0, $ln=1, $x='', $y='', $reseth=true, $stretch=0, $ishtml=false, $autopadding=true, $maxh=0, $valign='T', $fitcell=false) {
