...
|	
| -------------------------------------------------------------------------
| FILENAME - module_affiliate_payment_print_invoice_model.php
| -------------------------------------------------------------------------     
| 
| This model handles the functions for printing affiliate payment invoices
|
*/

class Module_Affiliate_Payment_Print_Invoice_Model extends CI_Model {	
	...
	{	
		...
		$config = array(
							'settings_key'	=>	'module_affiliate_payment_print_invoice_use_date_range',
							'settings_value'	=>	'0',
		...
		$config = array(
							'settings_key'	=>	'module_affiliate_payment_print_invoice_start_date',
							'settings_value'	=>	'',
							'settings_module'	=>	'affiliate_payment',
							'settings_type'	=>	'text',
							'settings_group'	=>	$id,
		...
		$config = array(
							'settings_key'	=>	'module_affiliate_payment_print_invoice_end_date',
							'settings_value'	=>	'',
							'settings_module'	=>	'affiliate_payment',
							'settings_type'	=>	'text',
							'settings_group'	=>	$id,
		...
		$config = array(
							'settings_key'	=>	'module_affiliate_payment_print_invoice_exclude_minimum',
							'settings_value'	=>	'0',
							'settings_module'	=>	'affiliate_payment',
							'settings_type'	=>	'dropdown',
							'settings_group'	=>	$id,
		...
		$config = array(
							'settings_key'	=>	'module_affiliate_payment_print_invoice_total_rows',
							'settings_value'	=>	'100',
							'settings_module'	=>	'affiliate_payment',
							'settings_type'	=>	'text',
							'settings_group'	=>	$id,
		...
		$config = array(
							'settings_key'	=>	'module_affiliate_payment_print_invoice_payment_details',
	...
	{	
		$invoices = $this->load->view('modules/tpl_adm_print_affiliate_payment_invoice_header', '', true);
		...
		foreach($data as $member)
		{
			...
			$invoices .= $this->load->view('modules/tpl_adm_print_affiliate_payment_invoice', $member, true);
