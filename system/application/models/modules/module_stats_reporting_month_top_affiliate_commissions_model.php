...
|	
| -------------------------------------------------------------------------
| FILENAME - module_stats_reporting_month_top_commissions_model.php
| -------------------------------------------------------------------------     
| 
...
class Module_Stats_Reporting_Month_Top_Affiliate_Commissions_Model extends CI_Model {	
	...
	function _generate_report($cmonth = '', $cyear = '')
	{
		...
		$sql = 'SELECT member_id, SUM(commission_amount) as amount,
