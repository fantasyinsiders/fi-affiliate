...
|	
| -------------------------------------------------------------------------
| FILENAME - module_account_ad_testing_model.php
| -------------------------------------------------------------------------     
| 
|
*/

class Module_Account_Add_Testing_Model extends CI_Model {	
	...
	function _run_module_testing($type = 'public', $id = '')
	{
		if ($type == 'public')
		{
			echo '<h1>This is the account add testing module being run after adding an account through the members registration area</h1>';
		}
		else
		{
			echo '<h1>This is the account add testing module being run after adding an account through the admin area</h1>';	
		}
