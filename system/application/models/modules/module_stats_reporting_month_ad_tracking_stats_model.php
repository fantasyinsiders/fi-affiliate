...
|	
| -------------------------------------------------------------------------
| FILENAME - Module_Stats_Reporting_Month_Ad_Tracking_Stats_model.php
| -------------------------------------------------------------------------     
| 
...
class Module_Stats_Reporting_Month_Ad_Tracking_Stats_Model extends CI_Model {	
	...
	function _generate_report($cmonth = '', $cyear = '', $id = '')
	{
	...
	function _generate_sales_report($cmonth = '', $cyear = '', $id = '')
	{
		$fdate = explode(':', $this->config->item('sts_admin_date_format'));
