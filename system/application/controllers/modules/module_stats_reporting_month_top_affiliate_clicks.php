...
|	
| -------------------------------------------------------------------------
| FILENAME - Module_Stats_Reporting_month_top_affiliate_clicks.php
| -------------------------------------------------------------------------     
| 
...
class Module_Stats_Reporting_Month_Top_Affiliate_Clicks extends Admin_Controller {
	
	function __construct()
	{
		parent::__construct();
		//load modules model
		$this->load->model('modules/module_stats_reporting_month_top_affiliate_clicks_model', 'modules');
		...
		$this->config->set_item('num_options', get_default_currency($this->config->item('sts_site_default_currency')));
		...
		//module name
		$this->config->set_item('module_name', 'module_stats_reporting_month_top_affiliate_clicks');
	...
	function generate()
	{
		...
		*/
		...
		$data['page_title'] = $this->lang->line('month_top_affiliate_clicks');
		$data['row_name'] = 'name';
		...
		if (!empty($data['stats']))
		{
			//$data['graph_data'] = $this->reports->_generate_flash_data_top($data['stats'], true);
