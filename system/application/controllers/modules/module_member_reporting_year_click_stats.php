...
class Module_Member_Reporting_Year_Click_Stats extends Member_Controller {
	
	function __construct()
	{
		parent::__construct();

		$this->load->model('modules/module_member_reporting_year_click_stats_model', 'modules');
	...
	function generate()
	{
		...
		$data['page_title'] = $this->lang->line('yearly_click_stats_by_month');
