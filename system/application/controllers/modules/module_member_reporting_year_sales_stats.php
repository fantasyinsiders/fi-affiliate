...
|	
| -------------------------------------------------------------------------
| FILENAME - Module_Member_Reporting_Year_Sales_Stats.php
| -------------------------------------------------------------------------     
| 
...
class Module_Member_Reporting_Year_Sales_Stats extends Member_Controller {
	
	function __construct()
	{
		parent::__construct();

		$this->load->model('modules/module_member_reporting_year_sales_stats_model', 'modules');
