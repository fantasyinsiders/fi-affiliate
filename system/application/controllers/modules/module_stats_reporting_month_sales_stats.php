...
class Module_Stats_Reporting_Month_Sales_Stats extends Admin_Controller {
	
	function __construct()
	{
		parent::__construct();
		//load modules model
		$this->load->model('modules/module_stats_reporting_month_sales_stats_model', 'modules');
		...
		//module name
		$this->config->set_item('module_name', 'module_stats_reporting_month_sales_stats');
