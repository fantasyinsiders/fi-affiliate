...
|	
| -------------------------------------------------------------------------
| FILENAME - Module_Stats_Reporting_Month_Commmission_Stats.php
| -------------------------------------------------------------------------     
| 
...
class Module_Stats_Reporting_Month_Commission_Stats extends Admin_Controller {
	
	function __construct()
	{
		parent::__construct();
		//load modules model
		$this->load->model('modules/module_stats_reporting_month_commission_stats_model', 'modules');
		...
		//module name
		$this->config->set_item('module_name', 'module_stats_reporting_month_commission_stats');
