...
|	
| -------------------------------------------------------------------------
| FILENAME - Module_Stats_Reporting_Year_Affiliate_Clicks_Stats.php
| -------------------------------------------------------------------------     
| 
...
class Module_Stats_Reporting_Year_Affiliate_Clicks_Stats extends Admin_Controller {
	
	function __construct()
	{
		parent::__construct();
		//load modules model
		$this->load->model('modules/module_stats_reporting_year_affiliate_clicks_stats_model', 'modules');
		...
		//module name
		$this->config->set_item('module_name', 'module_stats_reporting_year_affiliate_clicks_stats');
	...
	function generate()
	{
		...
		*/
		...
		$data['page_title'] = $this->lang->line('yearly_affiliate_clicks_stats_by_month');
