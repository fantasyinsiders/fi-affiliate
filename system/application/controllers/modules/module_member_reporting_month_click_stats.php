...
|	
| -------------------------------------------------------------------------
| FILENAME - Module_Member_Reporting_Month_Click_Stats.php
| -------------------------------------------------------------------------     
| 
*/

class Module_Member_Reporting_Month_Click_Stats extends Member_Controller {
	
	function __construct()
	{
		parent::__construct();

		$this->load->model('modules/module_member_reporting_month_click_stats_model', 'modules');
	...
	function generate()
	{
		...
		$data['page_title'] = $this->lang->line('monthly_click_stats_by_day');
