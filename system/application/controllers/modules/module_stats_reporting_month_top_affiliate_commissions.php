...
|	
| -------------------------------------------------------------------------
| FILENAME - Module_Stats_Reporting_month_top_affiliate_commissions.php
| -------------------------------------------------------------------------     
| 
...
class Module_Stats_Reporting_Month_Top_Affiliate_Commissions extends Admin_Controller {
	
	function __construct()
	{
		parent::__construct();
		//load modules model
		$this->load->model('modules/module_stats_reporting_month_top_affiliate_commissions_model', 'modules');
		...
		//module name
		$this->config->set_item('module_name', 'module_stats_reporting_month_top_affiliate_commissions');
	...
	function generate()
	{
		...
		*/
		...
		$data['page_title'] = $this->lang->line('month_top_affiliate_commissions');
		$data['row_name'] = 'name';
